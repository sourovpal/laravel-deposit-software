                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        @foreach ($contracts as $key => $contract)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                <td>
                                                    <img src="{{ asset('/frontend/images/contract/'.$contract->file) }}" height="80" alt="Event">
                                                    <a href="{{ asset('/frontend/images/contract/'.$contract->file) }}" class="btn btn-primary btn-sm ml-3" target="_blank">View</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-sm btn-info" href="{{route('dashboard.contract.edit', $contract->id)}}">
