                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        @foreach ($events as $key => $event)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                <td>
                                                    <img src="{{ asset('/frontend/images/event/'.$event->file) }}" height="80" alt="Event">
                                                    <a href="{{ asset('/frontend/images/event/'.$event->file) }}" class="btn btn-primary btn-sm ml-3" target="_blank">View</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-sm btn-info" href="{{route('dashboard.event.edit', $event->id)}}">
