            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">{{$user->name}} / Assign Products</h4>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(in_array($product->id, $assignIds))
                                                    <a class="btn btn-sm btn-danger" href="{{route('dashboard.user.add_product', [$user->id, $product->id])}}">Reset</a>
                                                    @else
                                                    <a class="bt n btn-sm btn-info" href="{{route('dashboard.user.add_product', [$user->id, $product->id])}}">Assign</a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
